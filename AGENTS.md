...
- If documentation and current code conflict, treat the current code as the source of truth, then update the stale documentation immediately so future agents do not follow outdated instructions.
