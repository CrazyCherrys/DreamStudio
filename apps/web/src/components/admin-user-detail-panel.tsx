    ...
    <div className="grid gap-5">
      ...
      {detail ? (
        <div className="grid min-w-0 gap-5 xl:grid-cols-[minmax(0,1fr)_420px]">
          <section className="rounded-[var(--ds-radius-sm)] border border-[var(--ds-border)] bg-[var(--ds-surface-raised)] p-5">
          ...
          <section className="rounded-[var(--ds-radius-sm)] border border-[var(--ds-border)] bg-[var(--ds-surface-raised)] p-5">
            ...
            {detail.new_api_config.last_test_error ? (
              <p className="mt-3 rounded-[var(--ds-radius-sm)] border border-[var(--ds-danger)]/30 bg-[var(--ds-surface)] p-3 text-sm font-semibold text-[var(--ds-danger)]">
                {detail.new_api_config.last_test_error}
              </p>
            ) : null}
          ...
          <section className="rounded-[var(--ds-radius-sm)] border border-[var(--ds-border)] bg-[var(--ds-surface-raised)] p-5">
            ...
            <div className="mt-4 grid gap-3">
              {detail.session_summary.recent.map((session) => (
                <div
                  className="rounded-[var(--ds-radius-sm)] border border-[var(--ds-border)] bg-[var(--ds-surface)] p-3 text-sm"
                  key={session.id}
                >
