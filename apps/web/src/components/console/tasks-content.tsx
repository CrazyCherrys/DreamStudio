...
export function ConsoleTasksContent() {
  ...
  return (
    <div className="admin-page">
      <section className="ds-card admin-panel p-6">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-4 text-2xl font-black">任务列表</h2>
      ...
      <section className="ds-card admin-panel flex flex-wrap gap-2 p-4">
...
function TaskListCard({
  ...
  return (
    <article className="ds-card admin-panel grid gap-4 p-5 lg:grid-cols-[minmax(0,1fr)_240px]">
        ...
        <div className="mt-4 flex flex-wrap gap-2">
          ...
          {task.result_assets.length > 0 ? (
            <Link
              ...
              href="/console/assets?kind=result_image"
            >
              结果图
            </Link>
          ) : null}
          <Link
            className="ds-button ds-button-secondary min-h-9 px-3 text-sm"
            href={{
              pathname: '/console/tasks/[task_id]',
              query: {
                task_id: task.id,
              },
            }}
