...
function ReferenceImageUploader({
  ...
  return (
    <form className="ds-card admin-panel grid gap-4 p-5" onSubmit={submitUpload}>
      <div>
        <span className="ds-badge">Reference</span>
        <h3 className="mt-4 text-xl font-black">上传参考图</h3>
...
function AssetGrid({
  ...
  if (items.length === 0) {
    return (
      <section className="ds-card admin-panel grid place-items-center p-10 text-center">
  ...
  return (
    <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-3">
      {items.map((asset) => (
        <article className="ds-card admin-panel overflow-hidden" key={asset.id}>
          <button
...
export function ConsoleAssetsContent({
  initialKind = 'result_image',
}: {
    ...
    <div className="admin-page">
      <section className="ds-card admin-panel p-6">
        <div className="flex flex-wrap items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-4 text-2xl font-black">我的作品</h2>
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_340px]">
        <section className="grid gap-4">
          <div className="ds-card admin-panel flex flex-wrap items-center justify-between gap-3 p-4">
            <div className="flex flex-wrap gap-2">
