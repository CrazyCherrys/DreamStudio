...
var upgrader = websocket.Upgrader{
	...
	// - The frontend passes ["dreamstudio-admin", "jwt.<token>"].
	// - We always select "dreamstudio-admin" so the token is never echoed back in the handshake response.
	Subprotocols: []string{"dreamstudio-admin"},
}
