...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	storageService := service.NewStorageService(settingService)
	...
	videoTaskService := service.NewVideoTaskService(videoTaskRepository, videoGenerationService, settingService)
	...
	healthHandler := handler.NewHealthHandler(storageService)
	...
	newAPIHandler := admin.NewNewAPIHandler(settingService)
	...
	handlers := handler.ProvideHandlers(authHandler, userHandler, userModelSettingsHandler, userAPISettingsHandler, imageGenerationHandler, redinkHandler, videoGenerationHandler, apiKeyHandler, usageHandler, galleryHandler, storageHandler, healthHandler, redeemHandler, subscriptionHandler, adminHandlers, gatewayHandler, openAIGatewayHandler, handlerSettingHandler)
