...
- mapping 映射到 Gemini `generationConfig.imageConfig.*`、`generationConfig.responseModalities` 和 `contents.parts`。
...
- 已支持 `generationConfig.responseModalities` 和 `generationConfig.imageConfig.aspectRatio/imageSize` 配置。
