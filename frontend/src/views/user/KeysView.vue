...
const allowCustomKey = computed(() => publicSettings.value?.user_custom_key_enabled ?? true)
...
watch(allowCustomKey, (enabled) => {
  if (!enabled) {
    formData.value.use_custom_key = false
