<template>
  <AppLayout>
    <div class="mx-auto max-w-4xl space-y-6">
      ...
      <CustomApiKeyCard v-if="isUserCustomKeyEnabled" />
...
import CustomApiKeyCard from '@/components/user/profile/CustomApiKeyCard.vue'
...
const isUserCustomKeyEnabled = computed(() =>
  appStore.cachedPublicSettings?.user_custom_key_enabled ?? false
)
